...
param vnetName = 'vnet' // Name of existing virtual network
param subnetName = 'snet-01' // Name of existing subnet
...
// For unit testing, provide a real resource ID or leave empty string to skip
param userAssignedIdentityResourceId = '/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg-example/providers/Microsoft.ManagedIdentity/userAssignedIdentities/id-ama-net-resilience'
