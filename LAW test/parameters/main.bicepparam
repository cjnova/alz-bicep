...
param workspaceName = 'law-net-resilience'  // Changed to avoid soft-deleted workspace
param dcrName = 'dcr-net-resilience-prod'

// Grafana parameters (max 23 characters)
param grafanaName = 'grafana-netres-prod'
