...
resource grafana 'Microsoft.Dashboard/grafana@2024-10-01' = {
  ...
  properties: {
    ...
    // Note: Integration with Log Analytics Workspace is done via RBAC (Monitoring Reader role)
    // configured in the main deployment template, not through grafanaIntegrations
  }
}
